...
ここが地味に効いていて、**「URLを渡すだけで読んでもらえる」状態**になりました。相手にリポジトリをcloneしてもらう必要も、Marpのビューアを入れてもらう必要も、PDFを添付して送る必要もありません。ブラウザさえあれば矢印キーでスライドを送れます。ドキュメントは書くだけでなく、**届ける経路まで作って初めて読まれる**のだと実感しています。
