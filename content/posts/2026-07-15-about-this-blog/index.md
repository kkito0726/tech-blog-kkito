---
title: Tech Blog始めました - Markdownを置くだけで公開されるブログを自作した話
date: 2026-07-15
...
このサイトは自分で作っていて、好きなことを好きなときに投稿していきます。この記事では、その技術スタックと、日々の執筆がどれだけシンプルになったかを紹介します。

## 注目すべき点: 執筆はMarkdownファイルを編集していくだけ
...
nvim content/posts/2026-07-20-my-new-post/index.md
